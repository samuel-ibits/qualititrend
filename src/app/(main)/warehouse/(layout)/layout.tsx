...
const WarehouseLayout = ({ children }: WarehouseLayoutProps) => {
  ...
  const [showCreateMaterialTransferModal, setShowCreateMaterialTransferModal] =
    useState(false);
  const [showCreateSupplyRequestModal, setShowCreateSupplyRequestModal] =
    useState(false);
  const [showWarehouseItemsFilterModal, setShowWarehouseItemsFilterModal] =
    useState(false);
