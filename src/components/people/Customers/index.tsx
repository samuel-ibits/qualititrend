...
const Customers = () => {
    ...
    const [showReceiveCustomerPaymentModal, setShowReceiveCustomerPaymentModal] = useState(false);
        ...
        <div>
            <div className='lg:flex lg:space-x-5 justify-between mb-8'>
                <div>
                    ...
                    <div className='mt-6'>
                        <h2 className="text-sm lg:text-base">Total Customers: <span className="text-primary font-semibold">100</span></h2>
                    </div>
                </div>
