...
type ReceiveCustomerPaymentModalProps = {
    showModal: boolean;
    setShowModal: (value: boolean) => void;
};

const ReceiveCustomerPaymentModal = ({
    showModal,
    setShowModal,
}: ReceiveCustomerPaymentModalProps) => {
        ...
        <Modal
            ...
            {step === "success" && (
                <section className='flex flex-col h-full justify-center items-center space-y-4'>
                    <Icons.SuccessIcon />
                    <p className='pb-10 text-center'>Payment received successfully</p>
                </section>
            )}
        </Modal>
    );
...
export default ReceiveCustomerPaymentModal;
