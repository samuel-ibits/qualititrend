...
import { useFetchPurchaseOrderDetailsQuery, useFetchPurchaseOrdersQuery } from "@/services/warehouse";
...
const PurchaseOrderDetail = () => {
    ...
    const {data:_data, isLoading, isError, error} = useFetchPurchaseOrderDetailsQuery({id:order_id as string})
    if (isLoading){
        return <div>
            Loading ...
        </div>
            ...
            <section className="space-y-6">
                ...
                <div className="px-6">
                    ...
                    <div className="flex gap-2 justify-between items-center">
                        <p> Total value: {formatAmount(Number(data.total_amount), "NGN")} </p>
