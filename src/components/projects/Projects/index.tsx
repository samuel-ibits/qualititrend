...
import { useFetchProjectsQuery, useFetchProjectsStatsQuery } from "@/services/projects";
...
const Projects = () => {
	...
	const { data: projects_stats, isSuccess:is_fetch_project_stats_success } = useFetchProjectsStatsQuery({})
	...
	return (
		<div>
			...
			<div className='mt-6'>
				<section className='lg:grid lg:grid-cols-3 lg:gap-8 max-lg:space-y-4'>
					<div className='col-span-2 space-y-6'>
						<Stats stats={is_fetch_project_stats_success ? generateStats():stats} showMobileTitle={false} />
					</div>
					<div className='col-span-1 space-y-6'>
						<SideStats stats={is_fetch_project_stats_success ? generateSideStats() : sideStats} />
					</div>
				</section>
			</div>
			<div className='mt-6'>
			...
			<div className='mt-6'>
				{ recent_projects && ( <ProjectsTable title="Recent Projects" data={recent_projects!} />) }
			</div>
			<CreateProjectModal
